...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="bodyMandarMensaje">
        ...
        <asp:Button ID="btnMandarMensaje" CssClass="btn btn-primary" runat="server" Text="Enviar mensaje" Width="280px" />
    </div>
    <hr />
    <div id="observadores">
        <h2>Observadores</h2>
        <div id="observador1">
            <p>Nombre: Octavio</p>
            <p>Mensaje:</p>
            <input id="msgOctavio" class="form-control" type="text" placeholder="Las notificacion llegaran aqui..." readonly>
        </div>
        <hr>
        <div id="observador2">
            <p>Nombre: Martin</p>
